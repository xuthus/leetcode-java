...
public class PointsSolutionTest {
    ...
    public void searchStarted() {
        ...
        for (int i = 0; i < 12; i++) {
            assertEquals(PointsSolution.searchStartedNaive(i, areas), PointsSolution.searchStartedQuick(i, areas));
        }
    }
    ...
    public void searchFinished() {
        ...
        assertEquals(PointsSolution.searchFinishedNaive(2, areas), PointsSolution.searchFinishedQuick(2, areas));
        for (int i = 0; i < 12; i++) {
            System.out.println(i);
            assertEquals(PointsSolution.searchFinishedNaive(i, areas), PointsSolution.searchFinishedQuick(i, areas));
        }
    }
