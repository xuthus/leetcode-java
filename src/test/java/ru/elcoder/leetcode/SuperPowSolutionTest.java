 ...
 */
public class SuperPowSolutionTest {

    private static int superPowBigDec(int a, int b, int m) {
        BigDecimal big = new BigDecimal(a);
        return big.pow(b).remainder(new BigDecimal(m)).intValue();
    }

    @Test
    public void superRow() throws Exception {
        SuperPowSolution solution = new SuperPowSolution();

        assertEquals(superPowBigDec(2, 3, 1337), solution.superPow(2, array(3)));
        assertEquals(superPowBigDec(123456, 372, 1337), solution.superPow(123456, array(3, 7, 2)));
        assertEquals(70, solution.superPow(78267, new int[]{
