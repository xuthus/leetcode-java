...
public class TreeNode1 {
    private TreeNode1 lt;     // contains nodes with values smaller than this node value
    private TreeNode1 gt;     // contains nodes with values greater than or equal to this node value
    ...
    public void insert(int value) {
        ...
        if (value < this.value) {
            if (lt == null)
                lt = new TreeNode1(value);
            else
                lt.insert(value);
        } else {
            if (gt == null)
                gt = new TreeNode1(value);
            else
                gt.insert(value);
        }
    }
    ...
    public void insertIterative(int value) {
        TreeNode1 parent = this;
        while (true) {
            parent.childCount++;
            if (value < parent.value) {
                if (parent.lt == null) {
                    parent.lt = new TreeNode1(value);
                    return;
                } else
                    parent = parent.lt;
            } else {
                if (parent.gt == null) {
                    parent.gt = new TreeNode1(value);
                    return;
                } else
                    parent = parent.gt;
            }
